            ...
            >
                ...
                <div className="hello w-full absolute right-[-10%] top-[45%] -translate-y-[50%] sm:right-[5%] lg:right-[10%] flex flex-col items-end" ref={hello}>
                    ...
                    <div className="flex flex-col items-end mt-2">
                        <h2 className="text-[6vw] font-semibold leading-none sm:text-[2.5rem] lg:text-[3.5rem] text-zinc-100 text-right drop-shadow-[0_0_12px_rgba(0,0,0,0.8)]">Inferastructures</h2>
                        <div className="flex items-center gap-2">
                            <h3 className="text-[4vw] font-medium leading-none sm:text-[1.5rem] lg:text-[2rem] text-zinc-100 text-right drop-shadow-[0_0_12px_rgba(0,0,0,0.8)]">Pvt. Ltd.</h3>
